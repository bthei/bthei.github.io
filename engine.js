...
/*
     ...
     INTERNET ARCHIVE ON 10:16:53 Jun 22, 2016.
...
function mediaExpander(pageDOM,mobile,popoutVideo){
	...
	$.each($(".video",pageDOM),function(index,object){
		if(!mobile)$(object).html($('<iframe src="/web/20131209111008/http://player.vimeo.com/video/'+$(object).attr("vimeo-desktop")+'?title=0&amp;byline=0&amp;portrait=0" width="500" height="500" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'));
...
function showVideoMobile(id){
	...
	top.append($('<iframe src="/web/20131209111008/http://player.vimeo.com/video/'+id+'?title=0&amp;byline=0&amp;portrait=0&amp;autoplay=1" width="320" height="320" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'));
	topOuter.append(top);
...
// Licenced for redistribution by Keaton Brandt, /web/20131209111008/http://keaton.ws
